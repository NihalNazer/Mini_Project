...
<br/> <hr/> <br/>
  ...
  $stra=" ";
	 ...
	 $selectEnq="SELECT a.En_ref, a.En_rcvbl, a.En_TDate, a.En_date, a.En_time, u.Name, i.IT_name , i.IT_id FROM  `inventry` a, `inventype` i, `user` u,  `district` d WHERE".$stra." a.En_type= i.IT_id  AND i.`IT_id`='99' AND a.En_wh = u.Uid AND d.Did=u.Dist  and u.Uid=$user AND (a.En_TDate>='$fdate' AND a.En_TDate<='$tdate') AND a.En_stat=1 ORDER BY En_TDate ASC, En_ref ASC, En_id ASC";
