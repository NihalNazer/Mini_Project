...
<div class="row">             
 ...
 <?php
          $selectLead="SELECT a.*, b.*, c.Officename, c.Pincode, e.* FROM  `order` a, `customer` b, `pin` c, `district` e WHERE a.`oid`='$refid' AND a.customerid= b.customerid AND b.post=c.Pid AND b.districtid=e.Did AND a.status=1 ";
          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
                <i class="fa fa-shopping-cart"></i> Invoice | ORDER
...
<!--invoice with tax and discount end here-->            
        <div class="row">
            <div class="col-xs-12">
                ...
                <center><small>
                If you have any questions, feel free mail to <b>info@htest.com </b> 
                </small></center>
          ...
          <div class="row no-print">
            ...
            <div class="btn-group">
                  ...
                  <button type="submit" name="accept"  class="btn btn-success"><i class="fa fa-thumbs-up"></i> Accept</button>
                   </form>
                   </div>
             ...
             <div class="btn-group">
                   ...
                   <input type="hidden" value="<?php echo $ordr; ?>" name="ordr">
                  <button type="submit" name="reject" onClick="return confirm('Are you sure you want to REJECT this?');"  class="btn btn-danger"><i class="fa fa-reply"></i> Reject</button>
                   </form>
                   </div>
