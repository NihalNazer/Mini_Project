      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-truck"></i> Trasactions Report</li>
          </ol>
        </section>
          ...
          <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title"> Inventory Trasactions Report</h3>
                </div><!-- /.box-header -->
               <?php
...
?>
                    ...
                    <button class="btn btn-info btn-flat" name="search" type="submit">Search</button>
                    </span>
...
<br/> <hr/> <br/>
  ...
  $stra=" ";
	 ...
	 $selectEnq="SELECT a.En_ref, a.En_rcvbl, a.En_TDate, a.En_qty, b.Product, u.Name, i.IT_name , i.IT_id FROM  `inventry` a, `product` b, `inventype` i, `user` u,  `district` d WHERE".$stra." a.En_type= i.IT_id AND a.En_wh = u.Uid and a.En_pro=b.pid AND d.Did=u.Dist and u.Uid=$user AND (a.En_TDate>='$fdate' AND a.En_TDate<='$tdate') AND i.`IT_id`!='99'  AND a.En_stat=1 ORDER BY En_TDate ASC, En_ref ASC, En_id ASC";
