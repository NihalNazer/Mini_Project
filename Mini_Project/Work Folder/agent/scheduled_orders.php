      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-lightbulb-o"></i> Scheduled Orders</li>
          </ol>
        </section>
          ...
          <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Scheduled Orders</h3>
                </div><!-- /.box-header -->
...
<div class="box-body">
					...
					$n=1;
	  $i = 0;
	$selectBase="select a.oid, ou.OSUremark, c.name, c.contactNum1, a.tqty, a.gtotal, a.oFlag, c.PDDate, c.PDTime, a.date  from `order` a, `order_status` g, `order_status_update` ou, `customer` c, `district` d where a.oallotment=$user and (a.oFlag=8 OR a.oFlag=9) AND (c.PDDate!='' OR c.PDTime!='') AND c.PDDate!=  '1970-01-01' AND a.oFlag = ou.OSid AND ou.Oid=a.oid AND g.OsId=a.oFlag and c.customerid=a.customerid and d.Did=c.districtid and  a.`status`='1' and a.tqty!=0 ORDER BY c.PDDate ASC, c.PDTime ASC";
	...
	?>
                      ...
                      <tr>
                        <td><?php echo $n; ?></td>
                        <td><?php echo $row["PDDate"]." ".$row["PDTime"]; ?></td>
