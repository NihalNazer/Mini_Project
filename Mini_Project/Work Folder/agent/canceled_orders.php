      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-times-circle"></i> Canceled Orders</li>
          </ol>
        </section>
...
<hr/>
					...
					$n=1;
	  $i = 0;
	$selectBase="select a.oid, ou.OSUremark, c.name, c.contactNum1, a.tqty, a.gtotal, a.oFlag, ou.OSUtime, a.date  from `order` a, `order_status` g, `order_status_update` ou, `customer` c, `district` d where  ou.OSUdate='$CurrentDate'  AND a.oFlag=12 AND a.oFlag = ou.OSid AND ou.Oid=a.oid AND g.OsId=a.oFlag and c.customerid=a.customerid and d.Did=c.districtid and a.oallotment=$user and a.`status`='1' and a.tqty!=0 ORDER BY ou.OSUid DESC";
