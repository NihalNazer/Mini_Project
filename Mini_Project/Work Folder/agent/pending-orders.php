      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-question-circle"></i> Order Summary</li>
          </ol>
        </section>
...
$ono=$ovalues=0;
	...
	$selectEnq="Select count(a.oid) as 'Nos',  SUM(a.gtotal) as 'values', os.OsName FROM  `order` a, `user` b, `order_status` os WHERE a.oallotment=b.Uid and b.Uid=$user AND os.OsId=a.oFlag and a.status=1 AND a.tqty!=0 AND (a.date>='$fdate' AND a.date<='$tdate') GROUP BY a.oFlag  HAVING (Nos>=1) ORDER BY 'values' DESC ";
