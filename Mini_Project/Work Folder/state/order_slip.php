...
if(isset($tme))
{ 
$selectTme="SELECT Did, District FROM  `district` WHERE `Did`='$tme' AND `Status`=1 ORDER BY District ASC";
...
<?php 
$selectTme="SELECT Did, District FROM  `district` WHERE `Status`=1 ORDER BY District ASC";
$resultTme=mysqli_query($con, $selectTme);
while($rowTme=mysqli_fetch_array($resultTme))
{
?>
