...
{
	echo"<script type=\"text/javascript\">
 window.location.assign(\"allotment.php\")
</script>";	
}
 ?>
<!DOCTYPE html>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-file-text"></i> Allotment</li>
          </ol>
        </section>
...
<div class="row">             
 ...
 <?php
					$selectLead="SELECT a.*, b.*, c.*, e.*, t.Taluk FROM  `order` a, `customer` b, `pin` c, `district` e, `taluk` t WHERE a.`eid`='$refid' and a.customerid= b.customerid AND b.post=c.Pid AND b.districtid=e.Did AND a.status=1  and t.Tid=c.Taluk";
           ...
           <form method="post" action="index.php">
             <div class="form-group">
              ...
              <select style="width:100%;" id="states" name="area" required>
               ...
               <option value="">Select Agent for <?php echo $tlk; ?> Taluk </option>
