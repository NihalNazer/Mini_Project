      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
           ...
           <li class="active"><i class="fa fa-shopping-cart"></i>Item Sales</li>
          </ol>
        </section>
...
if($item!='' && $qty!='' && $tdate!='')
	{ 
		$query="select `En_id` from `inventry` where `En_TDate`='$tdate' AND `En_ref` like '$refNo' and `En_type`=2 and `En_wh`='$refid' and `En_pro`='$item' and `En_stat`='1'";
        ...
        else
    {
      ...
      $advper=$joinQryResultRow1["aperc"];  
			...
			$updateEntry="INSERT INTO `inventry` (`En_id`, `En_ref`, `En_type`, `En_wh`,  `En_pro`, `En_rcvbl`, `En_date`, `En_TDate`, `En_time`, `En_qty`, `En_stat`, `En_flag`) VALUES (NULL, '$refNo', '2', '$refid', '$item','$advance', '$CurrentDate', '$tdate', '$CurrentTime', '$qty', '1', '1')";
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
               ...
               <i class="fa fa-shopping-cart"></i>
                  <h3 class="box-title">Item Entry (Sales)</h3>
                </div><!-- /.box-header -->
              ...
              <input id="Tdate" placeholder="Date of Tranasction" class="form-control" name="txtTdate" type="date" value="<?php echo @$tdate?>" />
               ...
               <div class="form-group">
               <label for="Inv">Sales Invoice Number<span style="color:#FF0000"></span></label>
              <input id="Inv" placeholder="Sales Invoice Number" class="form-control" name="txtInv" type="text" value="<?php echo @$inv?>" />
               </div> 
        			 <div class="form-group">
 ...
 <div class="col-md-6">
  <!-- TO DO List -->
   <?php
	...
	$page->show=3;
	$page->con=$con;
	$page->query="select a.*, b.* from `inventry` a, `product` b where a.En_pro=b.pid and a.En_stat='1' and a.En_wh=$refid and `En_type`=2 order by a.En_id DESC LIMIT 0,20 ";
   ?>
              <div class="box box-success">
                <div class="box-header">
               
                  <i class="fa fa-tags"></i>
                  <h3 class="box-title">Recently Sold Items</h3>
                ...
                <div class="box-body">
                  <ul class="todo-list">
                   ...
                   <?php
$select="select a.*, b.* from `inventry` a, `product` b where a.En_pro=b.pid and a.En_stat='1' and a.En_wh=$refid and `En_type`=2 order by a.En_id DESC LIMIT $pstart,$perpage";
//echo $select;
