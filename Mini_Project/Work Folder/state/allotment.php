...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="skin-black">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-paperclip"></i> Allotment</li>
          </ol>
        </section>
          ...
          <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Order for Allotment</h3>
	...
	$page->query="select a.oid, a.date, b.name, b.contactNum1, a.tqty, a.gtotal, a.oFlag, g.OsName, a.eid, c.Did, e.Officename, e.Pincode, a.oFlag from `order` a, `customer` b, `district` c, `pin` e,  `order_status` g where  a.`oFlag`='2' and a.customerid=b.customerid and b.districtid=c.Did and b.post=e.Pid and g.OsId=a.oFlag and a.`status`='1' and a.invtype=1 ".$qquery;
   ?>
