          ...
          <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Agents Details</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					?>
                      ...
                      <td><?php echo $n; ?></td>
                        ...
                        <td><?php if ($row["District"]==NULL){ echo "Not Configured";} else {echo $row["District"];} ?></td>
                         <td><?php if ($row["Phone"]==NULL){ echo "N/A";} else {echo $row["Phone"];} ?></td>
                          <td><?php if ($row["Email"]==NULL){ echo "N/A";} else {echo $row["Email"];} ?></td>
                          <td>
                   ...
                   <button type="submit" name="edist"  class="btn btn-success"><i class="fa fa-wrench"></i> Configure Agents</button>
                   </form>
                  </div> 
