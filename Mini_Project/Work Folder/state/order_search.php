...
<br/> <hr/> <br/>
  ...
  $selectBase="select a.oid, a.eid, c.District, a.date, b.name, b.contactNum1, a.tqty, a.gtotal, u.Name, g.OsName from `order` a, `customer` b, `district` c, `pin` e,  `order_status` g, `user` u where a.customerid=b.customerid and  b.districtid=c.Did and b.post=e.Pid and u.Uid=a.oallotment and (a.oFlag!='11' and a.oFlag!='12' and a.oFlag!='18' and a.oFlag!='19') and a.invtype='1' and g.OsId=a.oFlag and a.`status`='1' ";
