      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-truck"></i> District Wise Product Orders (Alloted)</li>
          </ol>
        </section>
          ...
          <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title">District Wise Product Orders(Alloted)</h3>
                </div><!-- /.box-header -->
               <?php
...
if(isset($tme))
{ 
$selectTme="SELECT * FROM  `product` WHERE `pid`='$tme' AND  `status`=1 ORDER BY Product ASC";
...
<br/> <hr/> <br/>
	  ...
	  if($tme!='')
	{
	$stme=" b.`Ccode`='$tme' AND ";
	}
	else
	{
	$stme=" ";
	}
	 $selectEnq="SELECT  d.District AS District, SUM(b.Qty) AS Orders, SUM(b.Gtotal) AS Value FROM  `order` a, `order_split` b,  `user` f,  `district` d WHERE".$stme." a.oid= b.Orderid AND a.oallotment = f.Uid
AND d.Did=f.Dist AND (a.date>='$fdate' AND a.date<='$tdate') AND b.Gtotal!=0  AND b.Status=1 GROUP BY d.Did ORDER BY `Value` DESC";
	...
	?>
	 ...
	 $selectEnqT="SELECT  d.District AS District, SUM(b.Qty) AS Orders, SUM(b.Gtotal) AS Value FROM  `order` a, `order_split` b,  `user` f,  `district` d WHERE".$stme." a.oid= b.Orderid AND a.oallotment = f.Uid
AND d.Did=f.Dist AND (a.date>='$fdate' AND a.date<='$tdate') AND b.Gtotal!=0  AND b.Status=1";
