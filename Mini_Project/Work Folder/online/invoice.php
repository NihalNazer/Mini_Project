...
<div class="row">             
 ...
 <?php
					$selectLead="SELECT a.*, b.*, c.*, e.* FROM  `order` a, `customer` b, `pin` c, `district` e WHERE a.customerid= b.customerid AND b.post=c.Pid AND b.districtid=e.Did AND a.status=1  AND a.tme='$user' AND a.`eid`='$refid'";
