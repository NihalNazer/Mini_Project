	...
	?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box bg-yellow">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">My Performance</span>
                  <span class="info-box-number">
                   <?php
	if($totcalls!=0){
	...
	?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box bg-red">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">My Value of Orders</span>
                  <span class="info-box-number">
                    <?php		 
	$selectEnqT="SELECT SUM(b.Gtotal) AS Value FROM  `order` a, `order_split`  b WHERE a.date='$CurrentDate' AND a.`tme`='$user' AND  a.oid= b.Orderid  AND b.Gtotal!=0  AND b.Status=1";
					...
					?>
                      <tr>
                       ...
                       <?php echo $rowEnq["remark"]; ?>
                         ...
                         <td>
						  <form action="manage_followups.php" method="post">
                  <input type="hidden" name="refid" value="<?php echo $rowEnq["eid"]; ?>" /> 
                  
                  
                  <button type="submit" name="btnRef"  class="btn btn-warning"><i class="fa fa-umbrella"></i> Follow</button>
