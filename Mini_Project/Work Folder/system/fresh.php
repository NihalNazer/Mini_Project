      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-paperclip"></i> Fresh Data Allotment</li>
          </ol>
        </section>
          ...
          <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><i class="fa fa-paperclip"></i> &nbsp; Fresh Data Allotment</h3>
                </div><!-- /.box-header -->
...
?>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					$n=1;
	  $i = 0;
	$selectEnq="SELECT b.`ncid`, b.`ncfor`, a.* FROM  `enquiry` a, `number_config` b WHERE a.lnode= b.ncid AND `userid`=0 AND a.status=1 AND a.fresh='1'";
