                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     <tr style="color:#000;">
                        ...
                        <td> Rs
<?php 
$resultSales=mysqli_query($con, "select SUM(a.En_rcvbl) as amount from `inventry` a, `district` b  where a.En_wh=b.agent and ".$stme."`En_type`=2 and `En_TDate`>='$fdate' and `En_TDate`<='$tdate' and `En_stat`=1");
...
?>
                  ...
                  <button type="submit" name="search"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View  </button>
                      ...
                      <tr style="color:#000;">
                        ...
                        <td>(Rs 
                          <?php 
$resultRet=mysqli_query($con, "select SUM(a.En_rcvbl) as amount from `inventry` a, `district` b  where a.En_wh=b.agent and ".$stme."`En_type`=3 and `En_TDate`>='$fdate' and `En_TDate`<='$tdate' and `En_stat`=1");
   ...
   <form action="trans-report.php" method="post" target="_blank">
                  ...
                  <button type="submit" name="search"  class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> View  </button>
                      ...
                      <tr style="ccolor:#000;">
                        ...
                        <td>Rs 
<?php 
$resultDel=mysqli_query($con, "select SUM(a.En_rcvbl) as amount from `inventry` a, `district` b  where a.En_wh=b.agent and ".$stme." `En_type`=4 and `En_TDate`>='$fdate' and `En_TDate`<='$tdate' and `En_stat`=1");
                  ...
                  <button type="submit" name="search"  class="btn btn-info btn-xs"><i class="fa fa-eye"></i> View  </button>
                      ...
                      <tr style="ccolor:#000;">
                       ...
                       <tr style="color:#000;">
                        ...
                        <td>(Rs 
<?php 
$resultPay=mysqli_query($con, "select SUM(a.En_rcvbl) as amount from `inventry` a, `district` b  where a.En_wh=b.agent and ".$stme." `En_type`=99 and `En_TDate`>='$fdate' and `En_TDate`<='$tdate' and `En_stat`=1");
...
<?php 
$resultCur=mysqli_query($con, "select SUM(a.balance) as amount from `user` a, `district` b where ".$baltme."a.Uid=b.agent and a.Status=1");
