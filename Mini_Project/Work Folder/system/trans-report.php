      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-truck"></i> Transactions Report</li>
          </ol>
        </section>
          ...
          <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title"> Inventory Transactions Report</h3>
                </div><!-- /.box-header -->
               <?php
...
<br/> <hr/> <br/>
  ...
  $stra=" ";
	 ...
	 $selectEnq="SELECT a.En_ref, a.En_rcvbl, a.En_TDate, a.En_qty, b.Product, u.Name, i.IT_name , i.IT_id FROM  `inventry` a, `product` b, `inventype` i, `user` u,  `district` d WHERE".$stme.$stra." a.En_type= i.IT_id AND a.En_wh = u.Uid and a.En_pro=b.pid
AND u.Uid = d.agent AND (a.En_TDate>='$fdate' AND a.En_TDate<='$tdate') AND i.`IT_id`!='99'  AND a.En_stat=1 ORDER BY En_TDate ASC, En_ref ASC, En_id ASC";
