      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-upload"></i> Data Upload (Secondary)</li>
          </ol>
        </section>
 ...
 <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header">
                  <h3 class="box-title">Upload Secondary Data (as .csv file)</h3>
                </div><!-- /.box-header -->
                                <?php
...
while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
	...
	if($firstRow) { $firstRow = false; }
		...
		{	
		$selectCustomer="Select `customerid` from `customer` where `contactNum1`='$tennumber' and `Status`=1";
					  ...
					  if($tennumber!='')
					  {
					  $import="INSERT into `enquiry`(eid,sid,vnum,lnode,vctime,ERemarks,status,customerid,fresh) values(NULL,'$data[0]','$tennumber','$myNumber','$data[2]','$data[3]','1','$cust','2')";
					  }
...
fclose($handle);
    ...
    <?php
	$selectNumbers="SELECT `ncid`, `ncfor` FROM  `number_config` WHERE `ncstatus`=1 AND `ncflag`=1 AND `freshness`=2  AND (ncfromDate<='$CurrentDate' AND nctoDate>='$CurrentDate') ORDER BY `ncfor` ASC";
