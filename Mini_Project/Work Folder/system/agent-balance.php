...
<br/> <hr/> <br/>
    ...
    $color="#000";
	 ...
	 $selectEnq="SELECT u.balance, u.ludate, d.District, u.lutime, u.luRid, u.Name FROM  `user` u,  `district` d WHERE  u.Uid = d.agent AND u.Categoryid=8 ORDER BY d.District ASC";
