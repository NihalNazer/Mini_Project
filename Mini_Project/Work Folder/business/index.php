	...
	while($rowEnq=mysqli_fetch_array($resultEnq))
	{
		echo $rowEnq["Ecount"];
				...
				?>
                  ...
                  <span class="progress-description"  style="cursor:pointer;" onClick="location.href='fresh-data-alloted.php'" >
...
while($rowOrdr=mysqli_fetch_array($resultOrdr))
{
 ...
 echo $rowCst["Ccount"];
				...
				?>
                  ...
                  <span class="progress-description"  style="cursor:pointer;" onClick="location.href='order_status.php'" >
                     Click here to go &raquo;
                  </span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
