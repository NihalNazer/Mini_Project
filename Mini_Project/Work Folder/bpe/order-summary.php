      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-shopping-cart"></i> Order Summary</li>
          </ol>
        </section>
	...
	?>
                 ...
                 <div class="col-xs-12">
						 <div class="btn-group">
                            ...
                            <div class="btn-group">
                           <!--  <form method="post" action="order-summary-report.php">
...
<br/> <hr/> <br/>
	 ...
	 $selectEnq="SELECT b.Ccode AS Item_Code, b.Citem AS Item, SUM(b.Qty) AS Orders, SUM(b.Gtotal) AS Value FROM  `order` a, `order_split`  b WHERE (a.date>='$fdate' AND a.date<='$tdate') AND a.`tme`='$user' AND a.oid= b.Orderid  AND b.Gtotal!=0  AND b.Status=1 GROUP BY b.Ccode ORDER BY `Value` DESC";
	...
	?>
	 ...
	 $selectEnqT="SELECT b.Ccode AS Item_Code, b.Citem AS Item, SUM(b.Qty) AS Orders, SUM(b.Gtotal) AS Value FROM  `order` a, `order_split`  b WHERE  a.`tme`='$user' AND  a.oid= b.Orderid  AND (a.date>='$fdate' AND a.date<='$tdate') AND b.Gtotal!=0  AND b.Status=1";
