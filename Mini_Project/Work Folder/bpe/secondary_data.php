      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa  fa-database"></i> Secondary Data</li>
          </ol>
        </section>
         ...
         <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><i class="fa fa-database"></i>&nbsp;Secondary Data</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
					$n=1;
					$selectEnq="SELECT a.*, b.ncfor, c.Name FROM  `enquiry` a, `number_config` b, `user` c WHERE  a.flag=0 AND a.userid='$user' AND a.fresh=2 AND a.lnode= b.ncid AND a.`userid`!=0 AND a.userid=c.Uid  AND a.status=1 ";
