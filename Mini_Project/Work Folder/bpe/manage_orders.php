...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="skin-black">
          ...
          <div class="col-xs-12">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Manage My Orders</h3>
                  <?php
	...
	$page->query="SELECT a.oid, a.date, b.name,  b.contactNum1, a.tqty, a.gtotal, a.oFlag, a.eid, a.oTime  FROM  `order` a, `customer` b WHERE a.invtype=1  AND a.customerid= b.customerid AND a.status=1  AND a.tme='$user' ".$qquery;
   ?>
