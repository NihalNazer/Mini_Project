...
$selectPost="select a.Pincode, a.Officename, c.Did, a.Pid from `pin` a, `taluk` b, `district` c where a.Taluk=b.Tid and b.Did=c.Did and a.Pid='$primaryPost' and a.Status='1'";
...
<form role="form" method="post" >
	  ...
	  ?>
          <?php
		   if(isset($_POST["dist"]) && $_POST["dist"]!=0)
 {
	 $did=$_POST["dist"];
	 $SelectArea="select a.Pincode, a.Officename, c.District, a.Pid from `pin` a, `taluk` b, `district` c  where b.Did='$did' and a.Taluk=b.Tid and b.Did=c.Did and a.Status=1";
 }
 else
 {
  ...
  <hr/>
               ...
               <div class="form-group">
                 ...
                 <input type="hidden" name="dist" value="<?php echo $did;  ?>" />
