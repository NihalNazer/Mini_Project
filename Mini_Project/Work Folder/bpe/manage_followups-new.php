...
<form role="form" method="post" >
	...
	$selectResponseCat="select * from `response_category` where `rtid`='$editCatId' and `rtstatus`='1' and `rflag`='1' order by `name` ASC";
	...
	?>
      ...
      <?php 
	$selectOtherCatg="select * from `response_category` where `rtid`!='$editCatId' and `rtstatus`='1' and `rflag`='1' order by `name` ASC";
...
else
{
  ...
  <div class="form-group">
                  ...
                  <div class="box-footer">
                   ...
                   <button type="submit" name="btnSave"  class="btn btn-primary"><i class="fa fa-save"></i> Save as follow Up</button>
                  </div>
                </form>
