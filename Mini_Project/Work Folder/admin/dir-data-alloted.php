          ...
          <div class="row">
           ...
           <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Alloted Data (Direct)</h3>
                </div><!-- /.box-header -->
...
<br/> <br/>
	...
	$selectEnq="SELECT a.*, b.*, c.Name FROM  `enquiry` a, `number_config` b, `user` c WHERE a.lnode= b.ncid AND a.`userid`!=0  AND (a.adate>='$fdate' AND a.adate<='$tdate') AND a.userid=c.Uid AND a.fresh=0 AND a.status=1".$filter;
