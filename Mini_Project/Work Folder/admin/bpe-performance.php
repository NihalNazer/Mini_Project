...
<br/> <hr/> <br/>
    ...
    (Select count(a.tme) FROM  `order` a WHERE a.tme=b.Uid AND a.status=1 AND a.oFlag=11 AND a.tqty!=0 AND (a.date>='$fdate' AND a.date<='$tdate') ) AS Del_Orders, 
	  round((((Select Total_Orders)/((Select Total_Calls)))*100),2) AS Conversion_Rate, 
    round((((Select Del_Orders)/((Select Total_Calls)))*100),2) AS Del_Rate,
	...
	?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $cur_Del=$rowEnq["Del_Orders"]; $Tot_Del_Orders=$Tot_Del_Orders+$cur_Del; ?></td>
                        <td><?php echo $rowEnq["Del_Rate"]; ?></td>
	...
	?>
                      ...
                      <tr>
                        ...
                        <td><span style="color:#F00; font-weight:bold;"><?php echo $Tot_Ord=$rowEnqT["Total_Orders"]; ?></span></td>
                        ...
                        <td><span style="color:#F00; font-weight:bold;"><?php echo $Tot_Del_Orders; ?> </span></td>
                        <td><span style="color:#F00; font-weight:bold;"><?php echo round((($Tot_Del_Orders/$Tot_Ord)*100),2); ?></span></td>
