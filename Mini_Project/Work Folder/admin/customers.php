              ...
              <div class="box box-success">
                ...
                <div class="box-body">
                  <ul class="todo-list">
                   ...
                   <?php
$select="SELECT b.date, b.oid, b.eid, a.Citem, a.Qty, g.OsName FROM  `order_split` a, `order` b, `product` c, `order_status` g WHERE a.Orderid=b.oid AND a.Ccode=c.pid AND  b.customerid='$custid' and g.OsId=b.oFlag order by b.oid DESC LIMIT $pstart,$perpage";
//echo $select;
